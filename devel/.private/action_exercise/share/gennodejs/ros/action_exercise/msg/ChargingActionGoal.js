...
let ChargingGoal = require('./ChargingGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class ChargingActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ChargingGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ChargingGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChargingActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ChargingGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ChargingGoal()
    }
...
module.exports = ChargingActionGoal;
