...
"""autogenerated by genpy from action_exercise/ChargingActionGoal.msg. Do not edit."""
import codecs
import sys
...
class ChargingActionGoal(genpy.Message):
  _md5sum = "1bd9ae5255dc272095f5b851af1d49a9"
  _type = "action_exercise/ChargingActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','action_exercise/ChargingGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ChargingActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = action_exercise.msg.ChargingGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = action_exercise.msg.ChargingGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.goal_charge,) = _get_struct_f().unpack(str[start:end])
      return self
