...
"""autogenerated by genpy from action_exercise/ChargingActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ChargingActionFeedback(genpy.Message):
  _md5sum = "b41a3d2831c87fe390d8c213684a635a"
  _type = "action_exercise/ChargingActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_exercise/ChargingFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ChargingActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = action_exercise.msg.ChargingFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action_exercise.msg.ChargingFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.current_charge
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_charge,) = _get_struct_f().unpack(str[start:end])
      return self
