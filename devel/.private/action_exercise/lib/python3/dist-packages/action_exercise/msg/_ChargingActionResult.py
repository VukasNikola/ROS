...
"""autogenerated by genpy from action_exercise/ChargingActionResult.msg. Do not edit."""
import codecs
import sys
...
class ChargingActionResult(genpy.Message):
  _md5sum = "3d5a8d7dc1b5e439373cc97603ee3541"
  _type = "action_exercise/ChargingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_exercise/ChargingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ChargingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_exercise.msg.ChargingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_exercise.msg.ChargingResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.charged,) = _get_struct_B().unpack(str[start:end])
      self.result.charged = bool(self.result.charged)
      return self
